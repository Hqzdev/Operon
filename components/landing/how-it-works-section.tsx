...
Why:
People are clicking, but not enough of them are buying.

Proof:
Strong interest, weak sales`,
  },
  {
    number: "III",
...
Next actions:
1. Test 3 new hooks
2. Shorten the first 3 seconds
3. Try a UGC-style angle`,
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three simple steps.
            <br />
            <span className="text-background/50">Input, analysis, actions.</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              ...
              <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-background/40">Live review</span>
              </div>
              ...
              <div className="px-6 py-4 border-t border-background/10 flex items-center gap-3">
                ...
                <span className="text-xs font-mono text-background/40">Ready to review</span>
              </div>
            </div>
          </div>
        </div>
